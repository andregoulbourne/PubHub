...
public class Book {
	...
	//++ setting tag with each contructor
	//---------------------------------------------------------------------------------A.G.

	// Constructor used when no date is specified
	public Book(String isbn, String title, String author, byte[] content, String tag) {
		this.isbn13 = isbn;
		this.title = title;
		this.author = author;
	...
	public Book(String isbn, String title, String author, byte[] content, LocalDate publishDate, String tag) {
		this.isbn13 = isbn;
		this.title = title;
		this.author = author;
